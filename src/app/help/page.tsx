...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "We currently support CSV imports from AmberApp, Coinbase, Kraken, Gemini, River, and Swan Bitcoin. Go to a wallet's detail page and click 'Import CSV' to upload your transaction history.",
  },
  {
  ...
  {
    question: "How do I manually edit my cost basis?",
    answer:
      "Go to the Gains page to view your tax lots. Click on any cost basis amount in the table to edit it. This is useful when on-chain data doesn't reflect your actual purchase price (e.g., if you bought on an exchange and later withdrew to self-custody). Edited values will show an 'Override' badge.",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2">
                  {["AmberApp", "Coinbase", "Kraken", "Gemini", "River", "Swan Bitcoin"].map((exchange) => (
        ...
        <section>
          ...
          <div className="card">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="mailto:selfcustodytax@proton.me"
